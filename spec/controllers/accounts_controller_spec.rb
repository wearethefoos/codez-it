...
describe AccountsController, focus: true do
  ...
  context "As a logged in Admin" do
    ...
    describe "GET index" do
      it "assigns all accounts as @accounts" do
        ...
        get :index
        assigns(:accounts).to_a.should eq(Account.all.to_a)
      end
    end
  ...
  context "As a logged in User" do
    ...
    describe "GET index" do
      it "assigns all accounts as @accounts" do
        Account.create! valid_attributes
        get :index
        assigns(:accounts).to_a.should_not eq(Account.all.to_a)
      end
    end
    ...
    describe "PUT update" do
      ...
      describe "DELETE destroy" do
      it "destroys the requested account" do
        account = Account.all.select{ |a|
          a.name.parameterize == @request.subdomain }.first
        expect {
          delete :destroy, {:id => account.to_param}
        }.to change(Account, :count).by(-1)
      end
